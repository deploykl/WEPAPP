"""
Django settings for sgi_app project.
...
SECRET_KEY = 'django-insecure-%00-^y!y)q&^1g2ow#6++3-9omv5xfx=h-suao+(aczr8wt8_t'
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",#optimiza rendimiento file staticos
